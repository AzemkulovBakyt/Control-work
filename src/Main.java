...
public class Main {
    public static void main(String[] args) {
        ...
        cats.add(new Cat("Peach",11,getRandom(),getRandom(),getRandom()));
        cats.add(new Cat("Jasper",12,getRandom(),getRandom(),getRandom()));
        cats.add(new Cat("Poppy",9,getRandom(),getRandom(),getRandom()));
        for (Cat c:
                cats) {
    ...
    private static int getRandom() {
        ...
        return (int)(Math.random() * 60.0) + 20;
    }
        ...
        switch (s){
            ...
            case "d":
                for (Cat c:cats) {
                    ...
                    c.setSatietyState(c.getSatietyState() + r.nextInt(5) + 1);
                    c.setFunctionState(true);
                }
    ...
    static int isNumber(String s)throws NumberFormatException{
        ...
        try{
            ...
            throw new NumberFormatException("Enter the age!!!");
        }
    }
